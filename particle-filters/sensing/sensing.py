...
landmarks = [[0.0, 100.0], [0.0, 0.0], [100.0, 0.0],
             [100.0, 100.0]]  # position of 4 landmarks in (y, x) form.
...
class robot:
    ...
    def sense(self, add_noise=True):  # do not change the name of this function
        ...
        for landmark in range(len(landmarks)):
            bearing = atan2(landmarks[landmark][0] - self.y,
                            landmarks[landmark][1] - self.x) - self.orientation
...
print('Measurements: ', my_robot.sense())
#
